...
export const ROUTES: RouteInfo[] = [
  ...
  {
    path: "/tournaments",
    title: "TOURNMAMTS.tournmants",
    type: "sub",
    icontype: "design_image",
    collapse: "tournaments",
    isCollapsed: true,
    children: [
      { path: "current", title: "TOURNMAMTS.tournmants", ab: "TT" },
      { path: "requests", title: "TOURNMAMTS.tournmants-requests", ab: "TR" },
      { path: "sponsorship", title: "TOURNMAMTS.sponsorship-requests", ab: "TS" },
      // { path: "manage-results", title: "TOURNMAMTS.manage-results", ab: "TT" },
    ]
  },
  // {
  //   path: "/components",
